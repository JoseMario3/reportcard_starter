...
const studentInformation = {
    ...
    graduationYear: "2024",
    imageUrl: "https://kirby.nintendo.com/assets/img/home/kirby-pink.png",
};
...
const studentGraduationElement = document.querySelector(
...
const winterSemesterElement = document.querySelector("#winter-term");
...
/**
 * Modify the report card to display the correct name from the lookup table above.
 *
...
function addCourseRowToReportCard(reportCardTableElement, course, rowNum) {
  ...
  <div class="table-row course-row row-${rowNum + 1} ${
    ...
    <div class="table-row">
      ...
      <h4 class="pts-col" id="gpa-${rowNum + 1}"> </h4>
      </div>
  </div>
  `;
}
...
window.onload = function() {
    ...
    updateReportCard(reportCardTableElement, studentData[semester]);
};